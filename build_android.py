...
def get_opts():
    ...
    return [
        ...
        ('ndk_platform', 'Target platform (android-<api>, e.g. "android-18")', "android-21"),
        EnumVariable('android_arch', 'Target architecture', "arm64v8", ('armv7', 'armv6', 'arm64v8', 'x86', 'x86_64')),
